...
//纪念日
let startDay = "2018/7/16";
//当地拼音,需要在下面的墨迹天气url确认
const local = "beijing/beijing-olympic-forest-park";

//发送者邮箱厂家
let EmianService = "QQ";
//发送者邮箱账户SMTP授权码
let EamilAuth = {
  user: "644423048@qq.com",
  pass: "afulwroydrdlbfjf"
};
//发送者昵称与邮箱地址
let EmailFrom = '"Eve" <644423048@qq.com>';

//接收者邮箱地
let EmailTo = "771751804@qq.com";
//邮件主题
let EmailSubject = "Test Email";

//每日发送时间
let EmailHour = 0;
let EmialMinminute= 07;
